...
\todo{generation of the images, the agent, quaternions, calculation of new rotations}

As can be seen in Figures~\ref{fig:la_agreement} and~\ref{fig:baseline_agreement}, this basic version of look around did not aid in answering location questions. \todo{new versions of look around}
