...
\begin{figure}[ht!]
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         ...
         \caption{Baseline Evaluation Accuracy} % SD 2021-05-01 16:14:52 +0200: What is smoothed 0.6?
...
\label{sec:exp_2}
\subsection{Method}
\todo{cite the paper about how categories helped with identifying unusual colors for an object}
...
6 & 74890.796875 & 0.325000 & \textbf{0.325000}
\end{tabular}
