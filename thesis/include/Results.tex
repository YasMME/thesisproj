...
Rotations are represented as quaternions, a compact representation that doesn't suffer from gimbal lock, a loss of a degree of freedom when axes are aligned with each other \cite{quaternions}.  These quaternions are expressed in [x, y, z, w]. The new rotations are calculated by: \\ \begin{math}
